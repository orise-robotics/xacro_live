...
@pytest.fixture
def robot_description_client(test_node):
    return RobotDescriptionClient(test_node('robot_description_client'))


@pytest.fixture
def handler(xacro_observer, robot_description_client):
    return XacroUpdateHandler(xacro_observer, robot_description_client)
...
def test_on_modify(handler, xacro_file):
    pass
